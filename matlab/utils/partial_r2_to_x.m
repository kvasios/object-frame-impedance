function J_r1 = partial_r2_to_x(xi)
...
r1=(( x1-x3 )/norm( x1-x3 ) + ( x2-x4 )/norm( x2-x4 ));
...
partial_r1__term1 = (-skew(r1)^2)/(norm(r1)^3);
...
J_r1 = -skew(r3_unit)*[J_r1_x1,J_r1_x2,J_r1_x3,J_r1_x4];
