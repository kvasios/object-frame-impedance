 ...
 */
FARPROC WINAPI gravity_dynamic_termDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = gravity_dynamic_termDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = gravity_dynamic_termDelayLoadWin32FailureHook;
#endif
