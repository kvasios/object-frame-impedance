...
static void c1_b_emlrt_marshallIn(SFc1_sf_newtons_cradleInstanceStruct
  *chartInstance, const mxArray *c1_p_out, const char_T *c1_name, real_T c1_y[7]);
static uint8_T c1_c_emlrt_marshallIn(SFc1_sf_newtons_cradleInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_sf_newtons_cradle, const
  char_T *c1_name);
static const mxArray *c1_d_emlrt_marshallIn(SFc1_sf_newtons_cradleInstanceStruct
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_c1_sf_newtons_cradle = 0U;
  for (c1_i0 = 0; c1_i0 < 7; c1_i0 = c1_i0 + 1) {
    (*c1_p)[c1_i0] = 0.0;
    (*c1_v)[c1_i0] = 0.0;
  }
  ...
  (SFc1_sf_newtons_cradleInstanceStruct *chartInstance)
{
  ...
  c1_st = NULL;
  sf_mex_assign(&c1_st, c1_emlrt_marshallOut(chartInstance));
  return c1_st;
}
  ...
  (SFc1_sf_newtons_cradleInstanceStruct *chartInstance)
{
  ...
  c1_p = (real_T (*)[7])(ssGetContStates(chartInstance->S) + 0);
  for (c1_i1 = 0; c1_i1 < 7; c1_i1 = c1_i1 + 1) {
    (*c1_p_dot)[c1_i1] = 0.0;
    (*c1_v_dot)[c1_i1] = 0.0;
  }
  ...
  for (c1_i1 = 0; c1_i1 < 7; c1_i1 = c1_i1 + 1) {
    ...
    (*c1_v_dot)[c1_i1] = -9.81 * (*c1_v_dot)[c1_i1];
  }
}
  ...
  (SFc1_sf_newtons_cradleInstanceStruct *chartInstance, real_T c1_u[7])
{
  ...
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 1, 7));
  return c1_y;
}
...
static void c1_b_emlrt_marshallIn(SFc1_sf_newtons_cradleInstanceStruct
  *chartInstance, const mxArray *c1_p_out, const char_T *
  c1_name, real_T c1_y[7])
{
  real_T c1_dv2[7];
  int32_T c1_i5;
  sf_mex_import(c1_name, sf_mex_dup(c1_p_out), &c1_dv2, 1, 0, 0U, 1, 0U, 1, 7);
...
static uint8_T c1_c_emlrt_marshallIn(SFc1_sf_newtons_cradleInstanceStruct
  *chartInstance, const mxArray *
  c1_b_is_active_c1_sf_newtons_cradle, const char_T *c1_name)
{
  uint8_T c1_y;
  uint8_T c1_u0;
  sf_mex_import(c1_name, sf_mex_dup(c1_b_is_active_c1_sf_newtons_cradle), &c1_u0,
                1, 3, 0U, 0, 0U, 0);
  c1_y = c1_u0;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(818341921U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(390860527U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(64921030U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2433888297U);
}
...
mxArray *sf_c1_sf_newtons_cradle_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(855450162U);
    pr[1] = (double)(1791656909U);
    pr[2] = (double)(24976998U);
    pr[3] = (double)(2786242789U);
...
static mxArray *sf_get_sim_state_info_c1_sf_newtons_cradle(void)
{
...
static mxArray* sf_internal_get_sim_state_c1_sf_newtons_cradle(SimStruct* S)
{
  ...
  prhs[3] = sf_get_sim_state_info_c1_sf_newtons_cradle();/* state var info */
...
static void sf_internal_set_sim_state_c1_sf_newtons_cradle(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
...
static mxArray* sf_opaque_get_sim_state_c1_sf_newtons_cradle(SimStruct* S)
{
...
static void mdlSetWorkWidths_c1_sf_newtons_cradle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("sf_newtons_cradle","sf_newtons_cradle",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("sf_newtons_cradle","sf_newtons_cradle",1,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("sf_newtons_cradle",
      "sf_newtons_cradle",1,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      sf_mark_chart_reusable_outputs(S,"sf_newtons_cradle","sf_newtons_cradle",1,
        2);
    }

    sf_set_rtw_dwork_info(S,"sf_newtons_cradle","sf_newtons_cradle",1);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
    ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
    ssSetCallsOutputInInitFcn(S,1);
  }

  ssSetChecksum0(S,(3664416797U));
  ssSetChecksum1(S,(864412899U));
  ssSetChecksum2(S,(4006052079U));
  ssSetChecksum3(S,(905557621U));
...
static void mdlRTW_c1_sf_newtons_cradle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "sf_newtons_cradle", "sf_newtons_cradle",1);
...
{
  SFc1_sf_newtons_cradleInstanceStruct *chartInstance;
  chartInstance = (SFc1_sf_newtons_cradleInstanceStruct *)malloc(sizeof
