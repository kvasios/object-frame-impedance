...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_ODE_Hand_Model_v08_IPC_v02_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ODE_Hand_Model_v08_IPC_v02_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_ODE_Hand_Model_v08_IPC_v02_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ODE_Hand_Model_v08_IPC_v02_autoinheritance_info(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_ODE_Hand_Model_v08_IPC_v02_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "ODE_Hand_Model_v08_IPC_v02") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_ODE_Hand_Model_v08_IPC_v02_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_ODE_Hand_Model_v08_IPC_v02_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"ODE_Hand_Model_v08_IPC_v02")) {
    return(sf_ODE_Hand_Model_v08_IPC_v02_method_dispatcher(simstructPtr,
...
extern void ODE_Hand_Model_v08_IPC_v02_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    ODE_Hand_Model_v08_IPC_v02_terminator();
    sf_debug_terminate();
  }
...
extern void ODE_Hand_Model_v08_IPC_v02_initializer(void);
extern void ODE_Hand_Model_v08_IPC_v02_register_exported_symbols(SimStruct* S);
extern void ODE_Hand_Model_v08_IPC_v02_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  ODE_Hand_Model_v08_IPC_v02_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      ODE_Hand_Model_v08_IPC_v02_debug_initialize();
    }

    ODE_Hand_Model_v08_IPC_v02_initializer();
  }
