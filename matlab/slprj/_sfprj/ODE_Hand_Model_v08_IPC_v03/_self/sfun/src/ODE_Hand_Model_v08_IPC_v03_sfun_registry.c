...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_ODE_Hand_Model_v08_IPC_v03_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ODE_Hand_Model_v08_IPC_v03_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_ODE_Hand_Model_v08_IPC_v03_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ODE_Hand_Model_v08_IPC_v03_autoinheritance_info(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_ODE_Hand_Model_v08_IPC_v03_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "ODE_Hand_Model_v08_IPC_v03") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_ODE_Hand_Model_v08_IPC_v03_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_ODE_Hand_Model_v08_IPC_v03_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"ODE_Hand_Model_v08_IPC_v03")) {
    return(sf_ODE_Hand_Model_v08_IPC_v03_method_dispatcher(simstructPtr,
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    ODE_Hand_Model_v08_IPC_v03_terminator();
  }
...
extern void ODE_Hand_Model_v08_IPC_v03_register_exported_symbols(SimStruct* S);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  ODE_Hand_Model_v08_IPC_v03_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    ODE_Hand_Model_v08_IPC_v03_initializer();
  }
