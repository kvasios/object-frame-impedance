...
#define S_FUNCTION_NAME ODE_Hand_Enviroment_Model_v07_Capsule_Control
...
static double radius = 0.47;
static double capsule_length = 1.10;
...
{
    float xyz[3] = {  0, 4.00, 3.70};   // view point; ??????x, y, z???[m]
    float hpr[3] = { -90.0, -10.50, 0.00};  // view direction; ??????(heading, pitch, roll)???[??]
