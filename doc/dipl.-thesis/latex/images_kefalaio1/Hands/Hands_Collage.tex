...
\begin{tikzpicture}[node distance=0.5\textwidth,auto,>=latex']
\node (image1) {\fbox{\includegraphics[width=0.5\textwidth,height =0.3\textheight]{images_kefalaio1/Hands/dlr_best.jpeg}}};
\node [right of = image1](image2) {\fbox{\includegraphics[width=0.32\textwidth, height =0.3\textheight]{images_kefalaio1/Hands/DLR_Hand}}};
\node [below of = image1](image3) {\fbox{\includegraphics[width=0.32\textwidth,height =0.2\textheight]{images_kefalaio1/Hands/tweedy}}};
\node [right of = image3,node distance=0.5\textwidth](image4) {\fbox{\includegraphics[width=0.55\textwidth,height =0.2\textheight]{images_kefalaio1/Hands/Robonauts_hand.jpg}}};
\node [below of = image3](image5) {\fbox{\includegraphics[width=0.3\textwidth,height =0.3\textheight]{images_kefalaio1/Hands/Shadow_Hand_Bulb_large_Alpha}}};
\node [right of = image5](image6) {\fbox{\includegraphics[width=0.5\textwidth,height =0.3\textheight]{images_kefalaio1/Hands/festo-exohand}}};
