...
\begin{tikzpicture}[node distance=0.33\textwidth,auto,>=latex']
%\node (image1) {\fbox{\includegraphics[width=0.32\textwidth,height =0.2\textheight]{boston-dynamics-alphadog-ls3-darpa-demo}}};
%\node [right of = image1](image2) {\fbox{\includegraphics[width=0.32\textwidth, height =0.2\textheight]{bostonatlas}}};
