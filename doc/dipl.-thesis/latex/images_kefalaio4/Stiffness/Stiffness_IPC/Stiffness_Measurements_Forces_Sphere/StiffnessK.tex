...
\node (image1) {\includegraphics[width=0.3\textwidth,height =0.2\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC/Stiffness_Measurements_Forces_Sphere/Kx_translational_stiffness}};
\node [right of = image1](image2) {\includegraphics[width=0.3\textwidth, height =0.2\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC/Stiffness_Measurements_Forces_Sphere/Ky_translational_stiffness}};
\node [right of = image2](image2) {\includegraphics[width=0.3\textwidth, height =0.2\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC/Stiffness_Measurements_Forces_Sphere/Kz_translational_stiffness}};
