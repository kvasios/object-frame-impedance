...
\begin{tikzpicture}[node distance=0.3\textwidth,auto,>=latex']
\node (image1) {\includegraphics[width=0.3\textwidth,height =0.2\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC/Stiffness_Measurements_Torques_Sphere/tau_x_rotational_error_stiffness}};
\node [right of = image1](image2) {\includegraphics[width=0.3\textwidth, height =0.2\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC/Stiffness_Measurements_Torques_Sphere/tau_y_rotational_error_stiffness}};
\node [right of = image2](image2) {\includegraphics[width=0.3\textwidth, height =0.2\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC/Stiffness_Measurements_Torques_Sphere/tau_z_rotational_error_stiffness}};
