...
\node (image1) {\includegraphics[width=0.3\textwidth,height =0.2\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC_Planar/Torques/K_x_stiffness}};
\node [right of = image1](image2) {\includegraphics[width=0.3\textwidth, height =0.2\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC_Planar/Torques/K_y_stiffness}};
\node [right of = image2](image2) {\includegraphics[width=0.3\textwidth, height =0.2\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC_Planar/Torques/K_z_stiffness}};
