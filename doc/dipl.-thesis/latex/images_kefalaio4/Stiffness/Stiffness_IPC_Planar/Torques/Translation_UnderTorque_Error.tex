...
\node (image1) {\fbox{\includegraphics[width=0.5\textwidth,height =0.3\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC_Planar/Torques/tau_x_translational_error}}};
\node [right of = image1](image2) {\fbox{\includegraphics[width=0.5\textwidth, height =0.3\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC_Planar/Torques/tau_y_translational_error}}};
\node [below of = image1](image3) {\fbox{\includegraphics[width=0.5\textwidth, height =0.3\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC_Planar/Torques/tau_z_translational_error}}};
