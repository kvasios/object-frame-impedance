...
\node (image1) {\fbox{\includegraphics[width=0.5\textwidth,height =0.3\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC_Planar/Forces/object_rotation_error_Force_x}}};
\node [right of = image1](image2) {\fbox{\includegraphics[width=0.5\textwidth, height =0.3\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC_Planar/Forces/object_rotation_error_Force_y}}};
\node [below of = image1](image3) {\fbox{\includegraphics[width=0.5\textwidth, height =0.3\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC_Planar/Forces/object_rotation_error_Force_z}}};
