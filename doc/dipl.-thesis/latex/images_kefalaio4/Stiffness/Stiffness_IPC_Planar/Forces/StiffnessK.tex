...
\node (image1) {\includegraphics[width=0.3\textwidth,height =0.2\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC_Planar/Forces/stiffness_f_x}};
\node [right of = image1](image2) {\includegraphics[width=0.3\textwidth, height =0.2\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC_Planar/Forces/stiffness_f_y}};
\node [right of = image2](image2) {\includegraphics[width=0.3\textwidth, height =0.2\textheight]{images_kefalaio4/Stiffness/Stiffness_IPC_Planar/Forces/stiffness_f_z}};
