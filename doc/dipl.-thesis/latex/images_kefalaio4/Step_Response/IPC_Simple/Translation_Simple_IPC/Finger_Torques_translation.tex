...
\node (image1) {\fbox{\includegraphics[width=0.5\textwidth,height =0.3\textheight]{images_kefalaio4/Step_Response/IPC_Simple/Translation_Simple_IPC/finger1_torques_translation.pdf}}};
\node [right of = image1](image2) {\fbox{\includegraphics[width=0.5\textwidth, height =0.3\textheight]{images_kefalaio4/Step_Response/IPC_Simple/Translation_Simple_IPC/finger2_torques_translation.pdf}}};
\node [below of = image1](image3) {\fbox{\includegraphics[width=0.5\textwidth, height =0.3\textheight]{images_kefalaio4/Step_Response/IPC_Simple/Translation_Simple_IPC/finger3_torques_translation.pdf}}};
\node [right of = image3](image4) {\fbox{\includegraphics[width=0.5\textwidth, height =0.3\textheight]{images_kefalaio4/Step_Response/IPC_Simple/Translation_Simple_IPC/finger_thumb_translation.pdf}}};
