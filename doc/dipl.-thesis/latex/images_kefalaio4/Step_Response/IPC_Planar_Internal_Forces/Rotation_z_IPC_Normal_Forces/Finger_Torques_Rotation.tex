...
\node (image1) {\fbox{\includegraphics[width=0.5\textwidth,height =0.3\textheight]{images_kefalaio4/Step_Response/IPC_Planar_Internal_Forces/Rotation_z_IPC_Normal_Forces/tau_finger1_translational_step_response_IPC_Normal.pdf}}};
\node [right of = image1](image2) {\fbox{\includegraphics[width=0.5\textwidth, height =0.3\textheight]{images_kefalaio4/Step_Response/IPC_Planar_Internal_Forces/Rotation_z_IPC_Normal_Forces/tau_finger2_translational_step_response_IPC_Normal.pdf}}};
\node [below of = image1](image3) {\fbox{\includegraphics[width=0.5\textwidth, height =0.3\textheight]{images_kefalaio4/Step_Response/IPC_Planar_Internal_Forces/Rotation_z_IPC_Normal_Forces/tau_finger3_translational_step_response_IPC_Normal.pdf}}};
\node [right of = image3](image4) {\fbox{\includegraphics[width=0.5\textwidth, height =0.3\textheight]{images_kefalaio4/Step_Response/IPC_Planar_Internal_Forces/Rotation_z_IPC_Normal_Forces/tau_finger_thumb_translational_step_response_IPC_Normal.pdf}}};
