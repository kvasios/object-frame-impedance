...
\tikzstyle{spring}=[thick,decorate,decoration={zigzag,pre length=0.3cm,post length=0.3cm,segment length=5}]
 \draw [black] (0.8,0.8) rectangle (9.2,9.2);
  \draw [black, thick] (2.0,2.0) rectangle (8,8);
 \node (x3) at (5,8.3){} ;
   \node (x1)at (5,1.7){} ;
    \node (x2) at (3.1,8.3){} ;
     \node (x4) at (6.9,8.3){} ;
    ...
    \node (p3) at (5,8.3-1.6){} ;
   \node (p1)at (5,1.7+1.6){} ;
    \node (p2) at (3.1,8.3-1.6){} ;
     \node (p4) at (6.9,8.3-1.6){} ;
     
     \node [above right] at (5,8.3){$x_3$} ;
   \node [below right] at (5,1.7){$x_1$} ;
    \node [above right] at (3.1,8.3){$x_2$} ;
     \node [above right] at (6.9,8.3){$x_4$} ;
     \node [right]at (5,6.3){$H_o=[R_o,x_o]$};
     \node [below right]at (2.5,4.2){$H_d=[R_d,x_d]$};
     \node [below right]at (5.5,5){$Anti-Gravity$};
     
     \node [red]at (5.5,2.5){$f_{s1}$};
     \node [red]at (3.7,7.6){$f_{s2}$};
     \node [red]at (5.5,7.6){$f_{s3}$};
     \node [red]at (7.3,7.6){$f_{s4}$};
     
    \draw  (5,8.24) circle [radius=0.23];
    \draw  (5,1.8) circle [radius=0.23];
     \draw  (3.1,8.24) circle [radius=0.23];
      \draw  (6.9,8.24) circle [radius=0.23];
       \draw  [fill=black] (5,6.3) circle [radius=0.1];
       \draw  [fill=black] (3,4.2) circle [radius=0.1];
%      
       \draw  [fill=black] (5, 8.3-1.6) circle [radius=0.05];
       \draw  [fill=black] (5,1.7+1.6) circle [radius=0.05];
       \draw  [fill=black] (3.1,8.3-1.6) circle [radius=0.05];
       \draw  [fill=black] (6.9,8.3-1.6) circle [radius=0.05];
       \draw  [fill=black] (5.5,5) circle [radius=0.03];
      
      \draw[red,decorate,decoration=zigzag] (x3) -- (p3);
      \draw[red,decorate,decoration=zigzag] (x1) -- (p1);
      \draw[red,decorate,decoration=zigzag] (x2) -- (p2);
      \draw[red,decorate,decoration=zigzag] (x4) -- (p4);
       \draw[blue,decorate,decoration=zigzag] (Hd) -- (Ho);
        \draw[green,decorate,decoration=zigzag] (G) -- (Ho);

       
       \draw (1.9+2.7,8) -- (1.9+2.7,7.6)--(1.9+3,7.6);
        \draw (2.7,8) -- (2.7,7.6)--(3,7.6);
         \draw (3.8+2.7,8) -- (3.8+2.7,7.6)--(3.8+3,7.6);
         \draw  (1.9+2.7,7.6-5.6)--(1.9+2.7,8-5.6) --(1.9+3,8-5.6);
%       \draw (0,0) -- (1,1) -- ();
%       \draw (0,0) -- (1,1) -- ();
%       \draw (0,0) -- (1,1) -- ();
