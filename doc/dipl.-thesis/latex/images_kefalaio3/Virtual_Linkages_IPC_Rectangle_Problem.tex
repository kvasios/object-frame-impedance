 ...
 \node (x3) at (5,8.3){} ;
   ...
   \node [below right] at (5,1.7){$x_1$} ;
    \node [above right] at (3.1,8.3){$x_2$} ;
     ...
     \node [right]at (5,6.6){$H_o=[R_o,x_o]$};
     \node [below right]at (2.5,4.2){$H_d=[R_d,x_d]$};
     
     \node [red]at (5.8,4.5){$K_{Conn1}$};
     \node [red]at (3.5,7.1){$K_{Conn2}$};
     \node [red]at (5.8,7.68){$K_{Conn3}$};
     \node [red]at (6.6,7.1){$K_{Conn4}$};
    ...
    \draw  (5,1.8) circle [radius=0.23];
     \draw  (3.1,8.24) circle [radius=0.23];
      \draw  (6.9,8.24) circle [radius=0.23];
       \draw  [fill=black] (5,6.6) circle [radius=0.1];
